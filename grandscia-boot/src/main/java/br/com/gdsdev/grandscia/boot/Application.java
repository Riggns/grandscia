package br.com.gdsdev.grandscia.boot;
...
@SpringBootApplication(scanBasePackages = {"br.com.gdsdev.grandscia.boot.components",
                                           "br.com.gdsdev.grandscia.application.service",
                                           "io.gumga",
                                           "br.com.gdsdev.grandscia.api"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBeanForSpringBoot.class, basePackages = {"br.com.gdsdev.grandscia.application.repository", "io.gumga"})
...
public class Application {
    ...
    public DataSource dataSource() {
        ...
        config.addDataSourceProperty("url", getProperties().getProperty("dataSource.url", "jdbc:h2:mem:grandscia;MVCC=true"));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain", "br.com.gdsdev.grandscia.domain.model");
