...
import br.com.gdsdev.grandscia.application.service.ProprietarioService;
...
public class ProprietarioAPI extends GumgaAPI<Proprietario, Long> {


    @Autowired
    public ProprietarioAPI(GumgaService<Proprietario, Long> service) {
        super(service);
    }
