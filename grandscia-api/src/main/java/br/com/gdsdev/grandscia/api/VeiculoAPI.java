...
import br.com.gdsdev.grandscia.application.service.VeiculoService;
...
public class VeiculoAPI extends GumgaAPI<Veiculo, Long> {


    @Autowired
    public VeiculoAPI(GumgaService<Veiculo, Long> service) {
        super(service);
    }
