...
import br.com.gdsdev.grandscia.application.service.ItemVendaService;
...
public class ItemVendaAPI extends GumgaAPI<ItemVenda, Long> {


    @Autowired
    public ItemVendaAPI(GumgaService<ItemVenda, Long> service) {
        super(service);
    }
