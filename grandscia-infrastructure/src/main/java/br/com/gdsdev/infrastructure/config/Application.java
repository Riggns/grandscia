package br.com.gdsdev.infrastructure.config;
...
@Configuration
@ComponentScan(basePackages = {"br.com.gdsdev", "io.gumga"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBean.class, basePackages = {"br.com.gdsdev", "io.gumga"})
...
public class Application {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain","br.com.gdsdev");
