define(function (require) {
    ...
    require('app/modules/proprietario/module');
    require('app/modules/marcamodelo/module');
    require('app/modules/categoria/module');
    require('app/modules/especie/module');
    require('app/modules/combustivel/module');
    require('app/modules/acessorios/module');
    require('app/modules/veiculo/module');
    require('app/modules/venda/module');
    //FIMREQUIRE
